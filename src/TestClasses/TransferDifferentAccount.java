...
public class TransferDifferentAccount {
    ...
    public static void main(String[] args) {
        ...
        Assert.assertTrue("result should be 804 but your result is " + u1.amountAccount1, u1.amountAccount1 == 804);
        Assert.assertTrue("result should be 3196 but your result is " + u2.amountAccount1, u2.amountAccount1 == 3196);
